...
const tools = ref([
  {
    id: 'my-ip',
    name: 'What is My IP',
    description: 'Cek IP Publik, ISP, dan Lokasi Anda saat ini.',
  ...
  },
  {
    id: 'ip-calculator',
    name: 'IP Calculator',
    description: 'Hitung Subnet Mask, Network, Broadcast, dan Host Range.',
  ...
  },
  {
    id: 'dns-lookup',
    name: 'DNS Lookup',
    description: 'Cek DNS record (A, CNAME, MX, TXT, dll) dari sebuah domain.',
